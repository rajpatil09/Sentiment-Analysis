...
writefile = open(filepath+"Senti/Senti_Twitter_Data.txt", "a+")
cnt_n=0
cnt_p=0
cnt=0
discard=0
...
for line in open(filepath+'Senti/Senti_Twitter_Data.txt', 'r'):
	word_tokens = word_tokenize(line)
...
save_features = open("Twitter/Senti/Senti_Features.pickle","wb")
pickle.dump(word_features, save_features)
save_features.close()

random.shuffle(documents)	
save_docs = open("Twitter/Senti/Senti_DocsLabels.pickle","wb")
...
getFeatures = open("Twitter/Senti/Senti_Features.pickle", "rb")
word_features = pickle.load(getFeatures)
getFeatures.close()

getDocs = open("Twitter/Senti/Senti_DocsLabels.pickle", "rb")
